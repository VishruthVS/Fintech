          ...
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              ...
              <div className="md:hidden outline-none">
                <button
                  className="p-2 text-gray-700 rounded-md outline-none focus:outline-none focus:border-gray-400 focus:border"
            ...
            >
              <ul className="h-screen md:h-auto items-center font-semibold justify-center md:flex ">
                <li className="pb-6 text-xl text-white py-2 md:px-6 text-center border-b-2 md:border-b-0  hover:bg-purple-900  border-purple-900  md:hover:text-purple-600 md:hover:bg-transparent">
                  <Link href="#mlaudit" onClick={() => setNavbar(!navbar)}>
                    ML Audit
                  </Link>
                </li>
                <li className="pb-6 text-xl text-white py-2 px-6 text-center  border-b-2 md:border-b-0  hover:bg-purple-600  border-purple-900  md:hover:text-purple-600 md:hover:bg-transparent">
                  <Link href="#games" onClick={() => setNavbar(!navbar)}>
                    Games
                  </Link>
                </li>
                <li className="pb-6 text-xl text-white py-2 px-6 text-center  border-b-2 md:border-b-0  hover:bg-purple-600  border-purple-900  md:hover:text-purple-600 md:hover:bg-transparent">
                  <Link
                    href="https://dao.matcrypt.com/"
                    onClick={() => setNavbar(!navbar)}
                  >
                    MatCrypt DAO
                  </Link>
                ...
                <li className="pb-6 text-xl text-white py-2 px-6 text-center  border-b-2 md:border-b-0  hover:bg-purple-600  border-purple-900  md:hover:text-purple-600 md:hover:bg-transparent">
                  <Link href="#nodes" onClick={() => setNavbar(!navbar)}>
                    Nodes
                  </Link>
                </li>
              </ul>
